...
static luaL_Reg func[] = {
    { "paraIP", inet_global_toip},
    { "consulte", inet_global_getaddrinfo},
    { "paraNomeHospedeiro", inet_global_tohostname},
    { "obterNomes", inet_global_getnameinfo},
    { "obterNomeLocal", inet_global_gethostname},
    { NULL, NULL}
};
...
static int inet_global_getnameinfo(lua_State *L) {
    ...
    if (!(host || serv))
        luaL_error(L, "hospedeiro e servi\xC3\xA7o n\xC3\xA3o podem ser ambos nulos");
...
{
    static const char* optname[] = { "qualquer", "ipv4", "ipv6", NULL };
...
{
    static const char* optname[] = { "fluxo", "datagrama", NULL };
...
static int inet_global_getaddrinfo(lua_State *L)
{
    ...
    for (iterator = resolved; iterator; iterator = iterator->ai_next) {
        ...
        switch (iterator->ai_family) {
            case AF_INET:
                lua_pushliteral(L, "fam\xC3\xADlia");
            ...
            case AF_UNSPEC:
                lua_pushliteral(L, "fam\xC3\xADlia");
                lua_pushliteral(L, "qualquer");
                lua_settable(L, -3);
                break;
            default:
                lua_pushliteral(L, "fam\xC3\xADlia");
                lua_pushliteral(L, "desconhecida");
                lua_settable(L, -3);
                break;
        }
        lua_pushliteral(L, "endere\xC3\xA7o");
        lua_pushstring(L, hbuf);
        lua_settable(L, -3);
        lua_settable(L, -3);
        i++;
...
int inet_meth_getpeername(lua_State *L, p_socket ps, int family)
{
    ...
    switch (family) {
        ...
        case AF_UNSPEC: lua_pushliteral(L, "qualquer"); break;
        default: lua_pushliteral(L, "desconhecida"); break;
    }
    return 3;
}
